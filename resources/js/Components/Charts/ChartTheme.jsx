...
export const CHART_COLORS = {
    gold:      'var(--clr-gold-500, #eab308)',
    goldLight: 'var(--clr-gold-300, #fde68a)',
    goldDark:  'var(--clr-gold-700, #a16207)',
    burgundy:  'var(--clr-burgundy-700, #7f1d1d)',
    burgundyMid: 'var(--clr-burgundy-600, #991b1b)',
    burgundyLight: 'var(--clr-burgundy-300, #fca5a5)',
    info:      'var(--clr-info, #38bdf8)',
    success:   'var(--clr-success, #4ade80)',
    warning:   'var(--clr-warning, #fb923c)',
    slate:     'var(--clr-surface-400, #94a3b8)',
    slateLight:'var(--clr-surface-300, #cbd5e1)',
    slateDark: 'var(--clr-surface-600, #475569)',
